...
\section{Railway Networks} % \label{sec:railway-networks-implementation}

A railway network can be represented as a tuple (triple) of the following: A map
...
\subsection{Network thoughts} % \label{sec:network-thoughts}
